...
export default function Election({ userId }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#41362A] to-[#41362A] text-white p-5">
      ...
      <button onClick={saveSelection} className="mt-8 justify-center px-6 py-3 bg-[#D77E1D] hover:bg-blue-700 rounded-lg text-white font-bold">Save Selection</button>
    </div>
  )
}
